...
const About = () => {
  const bestWebsitePhotos = [
    'public/img/iPhone-13-PRO-localhost.png',
    'public/img/Captura de pantalla 2024-10-01 111251.png',
    'public/img/Captura de pantalla 2024-10-01 111303.png',
  ];
...
<div className="py-16 flex flex-col lg:flex-row items-center">
  ...
  <div className="lg:w-1/2 flex justify-center items-center">
    <div className="grid grid-cols-2 gap-4">
      {[
        "public/icons/codificacion.png",
        "public/icons/icons8-google-code-50.png",
        "public/icons/icons8-hablar-con-descaro-a-48.png",
        "public/icons/icons8-mongo-db-48.png",
        "public/icons/icons8-reaccionar-40.png",
        "public/icons/icons8-viento-de-cola-css-48.png",
        "public/icons/js.png",
        "public/icons/mysql.png",
        "public/icons/php.png",
        "public/icons/postgre.png",
        "public/icons/programacion.png",
      ].map((icon, index) => (
        <div key={index} className="w-16 h-16 border border-gray-300 rounded-lg flex justify-center items-center hover:bg-gray-100 transition-all duration-200">
          ...
          <div className="py-16 flex flex-col lg:flex-row items-center">
            ...
            <div className="lg:w-1/2">
              <img src="public/imgs/425354974_10232503182029066_2899442653006001819_n.jpg" alt="Journey" className="rounded-lg w-full object-cover" />
            </div>
          </div>
        <hr className="border-t border-gray-300 my-8 w-full mx-auto" />
      <div className="py-16 text-center bg-gray-100 flex">
    ...
    View My CV
        ...
        <div className="hidden lg:flex lg:w-[25%] flex-col space-y-4 justify-start items-center fixed right-[.5%] top-[18%] h-[80vh] overflow-y-scroll">
          <div className="w-40 h-40 bg-gray-200 rounded-lg shadow-lg">
            <img src="public/imgs/Imagen de WhatsApp 2024-09-30 a las 22.31.18_adda62d5.jpg" alt="Hobby 1" className="w-full h-full object-cover rounded-lg border-8 " />
          </div>
          <div className="w-40 h-40 bg-gray-200 rounded-lg shadow-lg">
            <img src="public/imgs/photo_2024-09-23_22-25-28.jpg" alt="Hobby 2" className="w-full h-full object-cover rounded-lg border-8" />
          </div>
          <div className="w-40 h-40 bg-gray-200 rounded-lg shadow-lg">
            <img src="public/imgs/photo_2024-09-30_15-30-39.jpg" alt="Hobby 3" className="w-full h-full object-cover rounded-lg border-8" />
          </div>
          <div className="w-40 h-40 bg-gray-200 rounded-lg shadow-lg">
            <img src="public/imgs/Imagen de WhatsApp 2023-09-28 a las 18.46.17.jpg" alt="Hobby 3" className="w-full h-full object-cover rounded-lg border-8" />
          </div>
        </div>
      </div>
