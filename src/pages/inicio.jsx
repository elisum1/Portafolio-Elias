...
import leftImage from '/assets/img/Modificado.png';
import rightImage from '/assets/img/Untitled_design_1_-removebg-preview.png';
          ...
          <div className="flex justify-center">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-[80%] md:w-[50%] relative top-12">
              ...
              <div className="bg-white shadow-lg rounded-lg p-4 border border-gray-200 hover:shadow-2xl transition-shadow duration-300 ease-in-out h-[100%]">
                <img src="assets/imgs/Captura de pantalla 2024-02-17 093131.png" alt="Proyecto 1" className="w-full h-48 object-cover rounded-lg" />
                <div className="mt-4">
              ...
              <div className="bg-white shadow-lg rounded-lg p-4 border border-gray-200 hover:shadow-2xl transition-shadow duration-300 ease-in-out">
                <img src="assets/imgs/Captura de pantalla 2024-02-23 080844.png" alt="Proyecto 2" className="w-full h-48 object-cover rounded-lg" />
                <div className="mt-4">
              ...
              {/* Proyecto 3 */}
              <div className="bg-white shadow-lg rounded-lg p-4 border border-gray-200 hover:shadow-2xl transition-shadow duration-300 ease-in-out">
                <img src="assets/imgs/Captura de pantalla 2024-04-05 184436.png" alt="Proyecto 3" className="w-full h-48 object-cover rounded-lg" />
                <div className="mt-4">
